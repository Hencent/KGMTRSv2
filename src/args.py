...
class Args(object):
    def __init__(self):
        ...
        self.city_dianping_index_order = [[0, 1, 2, 14, 15, 17, 18, 23], [0, 1, 2, 16, 17, 19, 20, 26]]
        ...
        self.intentionally_ignored_shop_name = ["胡桃里"]
        self.small_cate_for_fitting_list = ["川菜馆", "清吧"]
        ...
        """
        self.test_data_mode = 1
        self.n_neg_grid = 60
        self.test_target_type_list = ["火锅", "四川火锅", "重庆火锅"]  # 指定类型
        self.test_file_target_shop_name = ["胡桃里"]  # 多类型数据中，哪些店名测试数据
        # self.K = 15
        self.K_list = [6, 10, 15]
